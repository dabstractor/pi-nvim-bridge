...
---@class pi-bridge.CmpSourceState
...
--- time (`require("pi-bridge").config`). Returns a fresh table whose metatable is
...
---                   cursorCol }` (see pi-bridge.CmpItemData). `bufnr` is REQUIRED (cmp's
